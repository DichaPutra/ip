            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">Detail Score</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    ?>
                                    <h2 class="text-center">IMPROVEMENT PLANNING SCORE <br>Departemen <?php echo "$departemen"; ?> <br><small>Periode Tahun <?php echo date("Y") + 1; ?></small></h2>
                                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            $count = 0;
                                            $totalscore = 0;
                                            foreach ($detailscore as $key) {
                                                $count++;
                                                ?>

                                                <tr>
                                                    <td><?php echo $key->namaDivisi; ?> - <?php echo $key->nama; ?></td>
                                                    <td><?php echo $key->score; $totalscore = $totalscore + $key->score; ?></td>
                                                    <td><?php echo $key->waktuinput; ?></td>
                                                </tr>
                                            <?php } ?>

                                        </tbody>
                                    </table>
                                    <br><h2 class="text-center pull-right">Average : 
                                        <?php
                                        if ($count == 0) {
                                            echo '0';
                                        } else {
                                            $hasilavg = round($totalscore / $count, 2);
                                            echo $hasilavg;
                                        }
                                        ?>
                                    </h2>
