...
<!--                                    <i class="fa fa-envelope-o"></i>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">Score Monitoring</a></li>
                        <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>index.php/KPI_planningscore_c">Planning Score</a></li>
                    </ol>
                </section>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="col-md-3  pull-right">
                                        <form method="post" action="<?php echo base_url(); ?>index.php/KPI_planningscore_c">
...
//                                                                echo "<div class=\"progress-bar progress-bar-success progress-bar-striped active\" role=\"progressbar\" aria-valuenow=\"5\" aria-valuemin=\"0\" aria-valuemax=\"6\" style=\"width: $persentase; \">" . $persentase . "($key->countScore/$key->countDivisi)";
//                                                            } else {
//                                                                $persentase = round($progress, 2) . "%";
//                                                                echo "<div class=\"progress-bar progress-bar-warning progress-bar-striped active\" role=\"progressbar\" aria-valuenow=\"5\" aria-valuemin=\"0\" aria-valuemax=\"6\" style=\"width: $persentase; \">" . $persentase . "($key->countScore/$key->countDivisi)";
//                                                            }
                                                    ?>
                                                        </div>
                                                    </td>-->
        ...
        <!--                                                    <td>
                                                            <a href="<?php echo base_url(); ?>index.php/KPI_planningscore_c/detailScore/<?php echo $key->id; ?>">
                                                                <button type="button" class="btn btn-sm btn-primary">Detail Score</button>
                                                            </a>
                                                        </td>-->
                                                </tr>
                                            <?php } ?>
