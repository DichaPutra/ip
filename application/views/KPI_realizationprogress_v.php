                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="col-md-3  pull-right">
                                        <form method="post" action="<?php echo base_url(); ?>index.php/KPI_realizationprogress_c">
                                ...
                                <div class="box-body">
                                    ...
                                    <h2 class="text-center">Realization Progress</h2>
                                    ...
                                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>AVG Realization Progress</th>
                                                <th>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            foreach ($departemen as $key) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 18%"><?php echo $key->nama; ?></td>
                                                    <td style="width: 25%">
...
//                                                                echo "<span class=\"label label-danger\">Belum Ada Progress</span>";
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/KPI_realizationprogress_c/detilRealisasi/<?php echo $key->id; ?>/<?php echo $tahun; ?>">
                                                            <button type="button" class="btn btn-sm btn-primary">Realization Detail</button>
                                                        </a>
                                                    </td>
                                                </tr>
<?php } ?>
