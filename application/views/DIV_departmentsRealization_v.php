                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    ...
                                    <h2 class="text-center">My Department Realization Progress</h2>
                                    <h4 class="text-center">Periode Tahun <?php echo date('Y'); ?></h4><br>
...
//                                                                echo "<span class=\"label label-danger\">Belum Ada Progress</span>";
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url(); ?>index.php/DIV_mydepartement_c/inputProgress/<?php echo $key->id; ?>">
                                                            <button type="button" class="btn btn-sm btn-primary">Input Progress</button>
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
