            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="#">View Planning</a></li>
                    </ol>
                </section>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <h1 style="color: blue" class="text-center">.:: <?php echo $departemen; ?> ::.</h1><hr>
                                            <h3 style="color: blue" class="text-center">Improvement List Periode Th. <?php echo $tahun ?></h3><br>
                                            <?php
//                                            var_dump($improvement);
                                            ...
                                            foreach ($improvement as $key) {
                                                ...
                                                echo "<p style=\"color: blue\" class = \"text-justify\"><b>$no. [$kodeimprovement] $key->judul_improvement</b><br></p>";
                                                echo "<xmp style=\"white-space:pre-wrap; word-wrap:break-word;\">$key->improvement</xmp>";
                                            }

//                                            var_dump($iddepartemen);
                                            ?>
                                    ...
                                    <!--
                                                                        <form method="POST" action="<?php echo base_url(); ?>index.php/DIV_planningScore_c/inputScore"> 
                                                                            ...
                                                                            <div class="modal-body">
                                                                                <h4 class="modal-title text-center">Input Score</h4>
